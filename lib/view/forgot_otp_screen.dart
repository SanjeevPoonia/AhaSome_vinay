...
class ForgotOTPScreen extends StatefulWidget {
  ...
  ForgotOTPScreen(this.otp, this.email, this.callbackType);

  OTPState createState() => OTPState();
}

class OTPState extends State<ForgotOTPScreen> {
  var _fromData;
  String otpText='';
  late Timer _timer;
  int _start = 20;
  ...
  _verifyOTPLocally() {
    if (userEnteredOTP == otpText) {
      ...
      Navigator.push(
          context,
          MaterialPageRoute(
              builder: (context) => ForgotPassword(widget.email)));
    } else {
