...
import 'package:aha_project_files/view/image_display_local.dart';
import 'package:aha_project_files/view/local_video_screen.dart';
...
class ChatScreen extends StatefulWidget {
  ...
  ChatScreen(this.id, this.name, this.imageUrl);
...
class ChatState extends State<ChatScreen> {
                            ...
                            child: Row(
                              children: [
                                ...
                                GestureDetector(
                                    ...
                                    child: RoundedImageWidget(widget.imageUrl)),
                                ...
                                PopupMenuButton<String>(
                                  ...
                                  itemBuilder: (BuildContext context) {
                                    return {'Report user', 'Block', 'Logout'}
                                        .map((String choice) {
                                                                        ...
                                                                        InkWell(
                                                                          onTap:
                                                                            ...
                                                                            if(lookupMimeType(
                                                                              ...
                                                                              {
                                                                                _downloadFile(
                                                                                    _returnUrlFile(chatList[pos]['attachment']),
                                                                                    pos);
                                                                              }
                                                                            else
                                                                              {
  ...
  refreshFileUpload(BuildContext context) async {
    ApiBaseHelper helper = ApiBaseHelper();
    var apiParams = {'id': widget.id, 'type': 'User', 'per_page': 5, 'page': 1};
    var response =
        await helper.postAPIWithHeader('fetchMessages', apiParams, context);
    var responseJson = jsonDecode(response.body.toString());
  ...
  makeSeen() async {
    ApiBaseHelper helper = ApiBaseHelper();
    var apiParams = {'id': widget.id, 'type': 'User'};
    var response =
  ...
  showSuccessDialog(BuildContext context) {
    ...
    AlertDialog alert = AlertDialog(
      ...
      content: Text(
        Platform.isIOS
            ? "File/Browse/On My iPhone/AHAsome"
            : "File downloaded at\n/storage/emulated/0/Android/data/com.happy.aha/files",
  ...
  Future<void> handleClickReport(String value) async {
    switch (value) {
      case 'Logout':
        ...
        break;
      case 'Report user':
        AppModel.setReportedId(widget.id);
